...
public class AMQPConfiguration {
    @Bean
    public TopicExchange challengeTopicExchange(@Value("${amqp.exchange.attempts}") String exchangeName) {
    ...
    @Bean
    public Binding correctAttemptBinding(final Queue gamificationQueue, final TopicExchange attemTopicExchange) {
        return BindingBuilder.bind(gamificationQueue).to(attemTopicExchange).with("attempt.correct");
    }
